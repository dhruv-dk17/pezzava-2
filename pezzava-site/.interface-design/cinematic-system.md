...
> **Query**: "Artisanal Premium Cinematic Editorial E-commerce" | **Tech Stack**: nextjs | **Generated**: 7/5/2026

## 01. Foundation
- **Primary Color**: `#EAECEE` ![#EAECEE](https://via.placeholder.com/15/EAECEE/000000?text=+)
- **Typography**: **Playfair Display** (Headings & Body)

### Color Palette
#### Primary Brand
| Stop | Hex | Preview |
| :--- | :--- | :--- |
| **50** | `#F0F2F4` | ![#F0F2F4](https://via.placeholder.com/80x30/F0F2F4/F0F2F4?text=+) |
| **100** | `#E1E6EA` | ![#E1E6EA](https://via.placeholder.com/80x30/E1E6EA/E1E6EA?text=+) |
| **200** | `#C6CCD2` | ![#C6CCD2](https://via.placeholder.com/80x30/C6CCD2/C6CCD2?text=+) |
| **300** | `#AAB3BB` | ![#AAB3BB](https://via.placeholder.com/80x30/AAB3BB/AAB3BB?text=+) |
| **400** | `#8E99A4` | ![#8E99A4](https://via.placeholder.com/80x30/8E99A4/8E99A4?text=+) |
| **500** | `#71808E` | ![#71808E](https://via.placeholder.com/80x30/71808E/71808E?text=+) |
| **600** | `#5B6671` | ![#5B6671](https://via.placeholder.com/80x30/5B6671/5B6671?text=+) |
| **700** | `#444D55` | ![#444D55](https://via.placeholder.com/80x30/444D55/444D55?text=+) |
| **800** | `#2D3339` | ![#2D3339](https://via.placeholder.com/80x30/2D3339/2D3339?text=+) |
| **900** | `#151A1E` | ![#151A1E](https://via.placeholder.com/80x30/151A1E/151A1E?text=+) |
| **950** | `#0B0D0F` | ![#0B0D0F](https://via.placeholder.com/80x30/0B0D0F/0B0D0F?text=+) |

#### Neutral
| Stop | Hex | Preview |
| :--- | :--- | :--- |
| **50** | `#F2F2F2` | ![#F2F2F2](https://via.placeholder.com/80x30/F2F2F2/F2F2F2?text=+) |
| **100** | `#E5E6E6` | ![#E5E6E6](https://via.placeholder.com/80x30/E5E6E6/E5E6E6?text=+) |
...
| **900** | `#191A1A` | ![#191A1A](https://via.placeholder.com/80x30/191A1A/191A1A?text=+) |
